DISCLAIMER: This executable is self-extracting: 2 batch scripts are extracted upon use, which can be considered a security vulnerability on some systems, user discretion is advised.
